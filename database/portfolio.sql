...
--
-- Hôte : localhost
-- Généré le : lun. 23 juin 2025 à 20:50
...
INSERT INTO `articles` (`id`, `title`, `link`, `github`, `path`, `description`, `created_at`, `updated_at`) VALUES
(1, 'Jadoo', 'https://jadoo-v2.vercel.app', 'https://github.com/silenthill99/jadoo-v2.git', 'images/Jadoo.png', 'Objectif : Créer un site web pour un restaurant japonais fictif afin d\'apprendre les bases du HTML et du CSS', '2025-06-18 12:42:59', '2025-06-18 12:42:59');
...
(4, '2025_06_11_101345_create_articles_table', 1),
(5, '2025_06_18_085012_create_messages_table', 1),
(6, '2025_06_19_123936_create_stages_table', 2);
...
INSERT INTO `stages` (`id`, `title`, `entreprise`, `competences`, `start_at`, `end_at`, `created_at`, `updated_at`) VALUES
(1, 'Développeur web', 'DevCSI', 'Début d\'apprentissage du HTML, CSS et JS', '2023-01-30 00:00:00', '2023-02-10 00:00:00', '2025-06-19 15:45:14', '2025-06-23 20:49:22');
...
(1, 'Florian GRAZIANI', 'florian.graziani@sfr.fr', '2025-06-18 12:42:59', '$2y$12$4SteutRRihfu.eyUrD8b2ObZwl793KFWop6XoAY6lSFd/w0KhiOja', NULL, '2025-06-18 12:42:59', '2025-06-18 12:42:59');
